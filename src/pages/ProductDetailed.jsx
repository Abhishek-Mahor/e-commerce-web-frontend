          ...
          <div>
                ...
                {product.size ? (
                  product.size.split(',').map(s => s.trim()).map(sz => (
                    <button
                      ...
                      className={`px-4 py-2 border rounded-md text-sm font-semibold transition cursor-pointer ${selectedSize === sz
            ...
            <div className='border-t pt-6'>
              ...
              <p className='text-gray-600'>
                High-quality {product.name} in {product.color || "Default"} color.
